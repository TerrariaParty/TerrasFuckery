...
namespace TerrasFuckery.Projectiles
{
    ...
    public abstract class WhipClass : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            player.GetModPlayer<TerraPlayer>().summonTagDamage = summonTagDamage;
            player.GetModPlayer<TerraPlayer>().summonTagCrit = summonTagCrit;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D value = mod.GetTexture("Projectiles/WhipTexture");
            ...
            for (int i = 0; i < list.Count - 1; i++)
            {
                ...
                Color color = GetColor(vector.ToTileCoordinates(), originalColor);
